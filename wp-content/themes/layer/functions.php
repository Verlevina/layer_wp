<?php
/**
 * layer functions and definitions
 *
...
if ( ! function_exists( 'layer_setup' ) ) :
	...
	function layer_setup() {
		 ...
		 * If you're building a theme based on layer, use a find and replace
		 * to change 'layer' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'layer', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'layer_custom_background_args', array(
 ...
 */
function layer_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'layer_content_width', 640 );
}
add_action( 'after_setup_theme', 'layer_content_width', 0 );
...
function layer_scripts() {
	wp_enqueue_style( 'layer-style', get_stylesheet_uri() );

	wp_enqueue_style( 'layer-main', get_template_directory_uri().'/css/main.css' );

	wp_enqueue_script( 'layer-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
